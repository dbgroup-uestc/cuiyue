...
def read_friend_data():
    ...
    for eachline in social_data:
        ...
        social_relations[uid2].append(uid1)#friend dual direction
...
def read_training_data():
    ...
    for eachline in train_data:
        ...
        training_matrix[uid, lid] = 1.0# 1 indicates having record
...
def main():
    ...
    for cnt, uid in enumerate(all_uids):
        if uid in ground_truth:
            ...
            precision.append(precisionk(actual, predicted[:10]))#note the difference betweent p@k and r@k
